...
import PreguntaCard2 from "./PreguntaCard2";

const PracticaDistanciaScreen = () => {
      ...
      {showInstrucciones ? (
        <View className="flex">
          ...
          <Text className="text-lg mt-5">
            ...
            cálculo de distancias. Se proporcionará una explicación detallada del
            procedimiento del problema, seguida de una lista de posibles
            soluciones. Una vez que el problema se haya completado, se mostrará
            la respuesta correcta junto con una explicación detallada.
          </Text>
          <TouchableOpacity
...
export default PracticaDistanciaScreen